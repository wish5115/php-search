//Strings
const CFG_SECTION = "phpManual";
const CFG_QUERY = "QueryTemplate";
const CMD_ID = "extension.phpManual";
...
function webSearch() {
  ...
  let phpManualCfg = vscode.workspace.getConfiguration(CFG_SECTION);
  const queryTemplate = phpManualCfg.get(CFG_QUERY);
